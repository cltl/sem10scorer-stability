...
public class NombankParser {
	 ...
	 */
	private NombankHandler handler;
	 ...
	 */
	public NombankParser() throws ParserConfigurationException, SAXException {
		...
		// create handler
		this.handler = new NombankHandler();
	}
	...
	public HashMap<String, ArrayList<NBRoleset>> getLemmaToRolesets() {
		return this.handler.getLemmaToRolesets();
	}
