...
public class Nonterminal {
	...
	/**
	 * Gets the head of this NT
	 * 
	 * @return the head of this NT
	 */
	 ...
	 * @param id
	 */
	public Nonterminal(String cat, String head, Id id) {
		super();
		this.cat = cat;
		this.head = head;
		this.id = id;
	...
	public String toString() {
		...
		if (head != null)
			buffer.append("<" + xmltag + " head=\"" + head + "\" cat=\"" + cat
					+ "\" id=\"" + id.getId() + "\">" + newline);
		else
			buffer.append("<" + xmltag + " cat=\"" + cat + "\" id=\""
					+ id.getId() + "\">" + newline);
