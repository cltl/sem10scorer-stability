...
public class FramesParser {
	 ...
	 */
	public FramesParser() throws ParserConfigurationException, SAXException {
		...
		// create handler
		this.handler = new FramesHandler();
	}
	 ...
	 */
	public void parseFramesFromFile(String aFileName) throws IOException,
			SAXException {
