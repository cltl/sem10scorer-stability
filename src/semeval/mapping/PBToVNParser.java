...
public class PBToVNParser {
	 ...
	 */
	public PBToVNParser() throws ParserConfigurationException, SAXException {
		...
		// create handler
		this.handler = new PBToVNHandler();
	}
