...
public class Terminal {
	...
	public boolean equals(Object anObject) {
		if (!(anObject instanceof Terminal))
			return false;
		Terminal other = (Terminal) anObject;
		if (anObject == this)
			return true;

		if (other.getId().getId().equals(this.getId().getId())
				&& other.getLemma().equals(this.getLemma())
				&& other.getPos().equals(this.getPos())
				&& other.getWord().equals(this.getWord())){
			return true;
		}
		return false;
	}
	 ...
	 * 'word') exist. But this does actually <strong>not conform</strong> to the
	 * SalsaXML.dtd.
	 * 
	 */
	public Terminal() {
