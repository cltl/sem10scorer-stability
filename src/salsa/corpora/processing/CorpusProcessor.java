...
public class CorpusProcessor {
	...
	private ArrayList<String> allTerminalIDs;
	...
	public ArrayList<String> getAllTerminals(Sentence aSentence, Nonterminal aNonterminal){
		allTerminalIDs = new ArrayList<String>();
		for(Terminal t : aSentence.getGraph().getTerminals().getTerminals())
			allTerminalIDs.add(t.getId().getId());
		
		ArrayList<String> terminals = new ArrayList<String>();
		
		for (Edge e : aNonterminal.getEdges()){
			String id = e.getId().getId();
			if(allTerminalIDs.contains(id))
				terminals.add(id);
			else{
				for(Nonterminal nt : this.getAllNonterminalsInCorpus()){
					if(nt.getId().getId().equals(id)){
						terminals.addAll(this.getAllTerminals(aSentence, nt));
						break;
					}
				}
			}
	...
	public Set<Terminal> getAllTerminals(ArrayList<Fenode> allFenodes) {
		...
		// gehe durch das Corpus und f�ge alle entsprechenden Terminals zu
		// 'allTerminals' hinzu
